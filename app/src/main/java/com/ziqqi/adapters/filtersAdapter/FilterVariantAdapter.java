...
public class FilterVariantAdapter extends RecyclerView.Adapter<FilterVariantAdapter.FiltersCategoriesViewHolder>  {
    Context context;
    List<FilterValue__> featureValues;
    int position;
    FilterItemListener listener;

    public FilterVariantAdapter(Context context, int position, List<FilterValue__> featureValues, FilterItemListener listener) {
    ...
    @NonNull
    @Override
    public FilterVariantAdapter.FiltersCategoriesViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflater = LayoutInflater.from(context).inflate(R.layout.item_filter, viewGroup, false);
        return new FilterVariantAdapter.FiltersCategoriesViewHolder(inflater);
    }

    @Override
    public void onBindViewHolder(@NonNull FilterVariantAdapter.FiltersCategoriesViewHolder holder, final int i) {
    ...
    public class FiltersCategoriesViewHolder extends RecyclerView.ViewHolder implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            listener.onFilterVariantClick(getAdapterPosition(), isChecked);
        }
    }
}