...
public class FilterCategoriesAdapter extends RecyclerView.Adapter<FilterCategoriesAdapter.FiltersCategoriesViewHolder>  {
    Context context;
    List<FilterValue> featureValues;
    int position;
    OnItemClickListener listener;

    public FilterCategoriesAdapter(Context context, int position, List<FilterValue> featureValues, OnItemClickListener listener) {
    ...
    @NonNull
    @Override
    public FilterCategoriesAdapter.FiltersCategoriesViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflater = LayoutInflater.from(context).inflate(R.layout.item_filter, viewGroup, false);
        return new FilterCategoriesAdapter.FiltersCategoriesViewHolder(inflater);
    }

    @Override
    public void onBindViewHolder(@NonNull FilterCategoriesAdapter.FiltersCategoriesViewHolder holder, final int i) {
